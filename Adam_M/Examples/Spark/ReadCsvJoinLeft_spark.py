...
#please notice in code you get NULL what means we don't have corresponding province/city record in regions
cases = cases.join(regions,['province','city'],how='left').select(cases.province,cases.city,regions.code,cases.infection_case,cases.confirmed)
